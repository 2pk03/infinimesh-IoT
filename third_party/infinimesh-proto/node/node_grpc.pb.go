...
const (
	...
	AccountsService_DeleteCredentials_FullMethodName = "/infinimesh.node.AccountsService/DeleteCredentials"
)
...
type AccountsServiceClient interface {
	...
	DeleteCredentials(ctx context.Context, in *DeleteCredentialsRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *accountsServiceClient) DeleteCredentials(ctx context.Context, in *DeleteCredentialsRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, AccountsService_DeleteCredentials_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountsServiceServer interface {
	...
	DeleteCredentials(context.Context, *DeleteCredentialsRequest) (*DeleteResponse, error)
...
func (UnimplementedAccountsServiceServer) Deletables(context.Context, *accounts.Account) (*access.Nodes, error) {
	return nil, status.Error(codes.Unimplemented, "method Deletables not implemented")
}
func (UnimplementedAccountsServiceServer) SetCredentials(context.Context, *SetCredentialsRequest) (*SetCredentialsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetCredentials not implemented")
}
...
func (UnimplementedAccountsServiceServer) DeleteCredentials(context.Context, *DeleteCredentialsRequest) (*DeleteResponse, error) {
...
func _AccountsService_DeleteCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountsServiceServer).DeleteCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountsService_DeleteCredentials_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServiceServer).DeleteCredentials(ctx, req.(*DeleteCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccountsService_DeleteCredentials_Handler,
		},
	},
...
func (UnimplementedNamespacesServiceServer) Joins(context.Context, *namespaces.Namespace) (*accounts.Accounts, error) {
	return nil, status.Error(codes.Unimplemented, "method Joins not implemented")
}
...
func (UnimplementedDevicesServiceServer) ToggleBasic(context.Context, *devices.Device) (*devices.Device, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleBasic not implemented")
}
func (UnimplementedDevicesServiceServer) MakeDevicesToken(context.Context, *DevicesTokenRequest) (*TokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MakeDevicesToken not implemented")
}
...
func (UnimplementedDevicesServiceServer) GetByFingerprint(context.Context, *devices.GetByFingerprintRequest) (*devices.Device, error) {
	return nil, status.Error(codes.Unimplemented, "method GetByFingerprint not implemented")
}
...
func (UnimplementedShadowServiceServer) StreamShadow(*shadow.StreamShadowRequest, grpc.ServerStreamingServer[shadow.Shadow]) error {
	return status.Error(codes.Unimplemented, "method StreamShadow not implemented")
}
func (UnimplementedShadowServiceServer) StreamShadowSync(*shadow.StreamShadowRequest, grpc.ServerStreamingServer[shadow.Shadow]) error {
	return status.Error(codes.Unimplemented, "method StreamShadowSync not implemented")
}
...
func RegisterShadowServiceServer(s grpc.ServiceRegistrar, srv ShadowServiceServer) {
	// If the following call panics, it indicates UnimplementedShadowServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (UnimplementedInternalServiceServer) GetLDAPProviders(context.Context, *EmptyMessage) (*LDAPProviders, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLDAPProviders not implemented")
}
